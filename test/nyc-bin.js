...
describe('the nyc cli', function () {
  ...
  describe('instrument', function () {
    ...
    describe('output folder specified', function () {
      ...
      it('allows a sub-directory to be excluded', function (done) {
        var args = [bin, 'instrument', '--exclude', '**/subdir/**', './', './output']
      ...
      it('allows a file to be excluded', function (done) {
        var args = [bin, 'instrument', '--exclude', 'subdir/input-dir/bad.js', './', './output']
        ...
        proc.on('close', function (code) {
          ...
          var files = fs.readdirSync(path.resolve(fixturesCLI, './output/subdir/input-dir'))
          files.should.include('index.js')
      ...
      it('allows specifying a single sub-directory to be included', function (done) {
        var args = [bin, 'instrument', '--include', '**/subdir/input-dir/bad.js', './', './output']
      ...
      it('allows a file to be excluded from an included directory', function (done) {
        var args = [bin, 'instrument', '--exclude', '**/bad.js', '--include', '**/subdir/input-dir/**', './', './output']
